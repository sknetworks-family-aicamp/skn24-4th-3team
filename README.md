...
-   **AI 기반 TBM 초안 작성 서비스**
    -   고용노동부가 TBM 기록을 안전교육 시간으로 인정함에 따라, HelpMet은 STT와 AI를 활용해 TBM 내용을 자동으로 정리하고 일지 초안을 생성합니다.
...
![기사1](./docs/images/기사1.png)<br>
![기사2](./docs/images/기사2.png)
...
- **TBM 일지 작성 자동화**
  ...
  - AI가 회의 내용을 바탕으로 작업 내용, 위험요인, 안전대책, 참석자 정보, 날씨 등을 정리하여 TBM 일지 초안을 생성합니다.

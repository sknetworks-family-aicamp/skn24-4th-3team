...
HelpMet은 매일 반복되는 TBM 일지 작성과 안전교육 기록 업무를 AI로 보조하여, 관리자가 현장 위험요인 확인과 작업자 안전교육이라는 본연의 임무에 더 집중할 수 있도록 돕습니다.
...
* **안전 지침 검색과 해석의 어려움:** 건설 현장은 비계, 굴착, 고소, 전기, 중장비 등 공정별 위험요인이 매우 다양합니다. 현장소장이 KOSHA GUIDE와 같은 방대한 기술지침을 직접 검색하고 현장 상황에 맞게 해석하여 적용하기에는 시간과 전문성의 한계가 따릅니다.
...
#### ( 5 ) 해결의 실마리 2 - 이미 다양한 스마트 안전관리 서비스의 존재

<p align="center">
  <img src="./docs/1.png" width="700" alt="SAFED 서비스 소개">
  <br>
  <em>[참고 1] SAFED: 방대한 위험요인 DB와 사고 예방률을 강조</em>
</p>

<p align="center">
  <img src="./docs/2.png" width="700" alt="페이퍼리 기대 효과">
  <br>
  <em>[참고 2] 페이퍼리(Paperly): 서류 작성 자동화 및 리스크 감소를 강조</em>
</p>

<p align="center">
  <img src="./docs/3.png" width="700" alt="새임 서비스 소개">
  <br>
  <em>[참고 3] 새임(SEIIM): 전담 인력 없이 대응 가능한 AI 컴플라이언스 시스템</em>
</p>

중대재해처벌법 확대와 건설 현장의 고질적인 인력 부족 문제를 해결하기 위해, 시장에는 이미 다양한 **스마트 안전관리 및 컴플라이언스 플랫폼**들이 등장하여 실질적인 성과를 내고 있습니다.

* **데이터 기반의 사고 예방:** 'SAFED'와 같은 서비스는 수만 건의 위험요인 DB를 구축하여 99% 이상의 높은 사고 예방률을 수치로 증명하며 현장의 안전도를 높이고 있습니다.
* **서류 자동화 및 리스크 저감:** '페이퍼리'는 현장의 가장 큰 고충 중 하나인 서류 작성 업무를 90% 이상 자동화하여 안전관리 이행률을 대폭 끌어올리고 과태료 리스크를 줄입니다.
* **AI 기반 무인 컴플라이언스:** '새임'은 전담 안전관리자가 부재한 소규모 현장에서도 AI와 클라우드를 활용해 중대재해처벌법의 복잡한 요구사항에 대응할 수 있는 체계를 제공합니다.

이러한 선행 서비스들의 안착은 **현장의 안전관리 디지털 전환(DX)과 업무 자동화가 단순한 기술적 트렌드를 넘어 필수적인 생존 전략**이 되었음을 확실히 증명합니다. 

HelpMet은 이러한 시장의 흐름 속에서, 무겁고 복잡한 전사적 시스템(ERP) 도입 비용과 학습 비용이 부담스러운 **소규모 현장**을 타겟으로 합니다. 매일 반복되는 가장 핵심적인 안전 활동인 **'TBM 일지 작성'**과 현장소장을 위한 **'KOSHA GUIDE 질의응답'**에 기능을 집중함으로써, 고령화된 현장에서도 도입 장벽 없이 즉시 사용할 수 있는 **가볍고 직관적인 현장 맞춤형 비서**로서 확실한 차별성을 가집니다.

> * [SAFED(세이프드): 데이터 기반 스마트 안전관리 플랫폼](https://www.safed.kr/)
> * [페이퍼리(Paiperly): 건설 현장 안전관리 업무 자동화 솔루션](https://www.paiperly.com/)
> * [새임(SEIIM): AI 기반 중대재해 컴플라이언스 시스템](https://www.seiim.co.kr/)

---

## 2-4 프로젝트 목표

* **TBM 일지 작성 자동화:** 음성 인식(STT) 기술을 활용하여 TBM 내용을 자동으로 텍스트화합니다. AI가 회의 내용을 바탕으로 작업 내용, 위험요인, 안전대책, 참석자 정보, 날씨 등을 정리해 일지 초안을 생성함으로써 서류 작성 부담을 획기적으로 줄입니다.
* **RAG 기반 KOSHA GUIDE 안전 챗봇 제공:** KOSHA GUIDE를 기반으로 사용자가 작업 상황을 질문하면 관련 안전 지침을 검색하여 현장에서 이해하기 쉬운 형태로 답변합니다. 복잡한 지침을 직접 찾지 않아도 즉각적인 안전 정보 확보가 가능합니다.
* **위험성평가와 TBM 기록의 연계:** TBM 내용에서 주요 작업, 위험요인, 예방대책을 추출하여 위험성평가에 활용할 수 있는 형태로 정리합니다. 단순한 회의 기록을 넘어 안전교육 이행 증빙 및 안전관리 데이터로 재사용할 수 있는 체계를 구축합니다.
* **소규모 건설 현장에 적합한 쉬운 사용성 제공:** 복잡한 대시보드 대신 음성 입력과 챗봇 질의응답 중심의 직관적인 UI를 모바일 환경에 맞게 제공하여, IT 기기에 익숙하지 않은 고령의 관리자도 쉽게 사용할 수 있도록 설계합니다.
* **실질적인 현장 안전 소통 강화:** 당일 작업자가 반드시 알아야 할 핵심 위험요인과 수칙을 TBM 과정에서 명확히 공유하도록 지원하여, 형식적인 서류가 아닌 실제 사고 예방 중심의 안전 문화를 정착시킵니다.
...
## 9. 수행결과 (테스트/시연 페이지)
- **시연 영상 또는 배포 링크:** [[http://3.38.36.204/](http://3.38.36.204/)]

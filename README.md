...
<p align="center">
  <img src="./docs/1.png" width="45%" alt="세이프디">
  <img src="./docs/3.png" width="45%" alt="페이퍼리">
  <br>
  <em>[참고 1] SAFED & 페이퍼리: 본사 관리자 중심의 고도화된 안전관리 시스템</em>
</p>

가장 대표적인 서비스인 **세이프디(SAFED)**와 **페이퍼리(Paiperly)**는 50,000건 이상의 방대한 위험 요인 DB를 보유하고 있으며, 안전 현황 보고서를 매우 체계적으로 관리합니다. 
...
<p align="center">
  <img src="./docs/3.png" width="45%" alt="TBM AI 서비스 예시 1">
  <img src="./docs/3-1.png" width="45%" alt="TBM AI 서비스 예시 2">
  <br>
...
#### 💡 HelpMet의 차별화된 경쟁력: "가볍지만 전문적인 AI 비서"

HelpMet은 기존 서비스들이 놓치고 있는 **'실질적인 안전 실무'**와 **'서류의 전문성'** 사이의 간극을 메우고자 합니다.

*   **정교한 AI 요약 및 법적 근거 제시:** 단순한 텍스트 변환을 넘어, TBM 내용을 핵심 위험 요인 위주로 정교하게 요약하고 관련 **KOSHA GUIDE 출처**를 명확히 표시하여 서류의 대외 신뢰도를 높입니다.
*   **날씨 API 연동 및 자동 환경 기록:** 작업 당일의 기상 상태를 API로 실시간 반영하여, 날씨에 따른 위험 요소(강풍 시 고소 작업 중단 등)를 지능적으로 가이드합니다.
*   **RAG 기반 실시간 질의응답:** 전문가가 없는 현장에서 소장님이 의문이 생길 때 즉시 물어보고 답변받을 수 있는 **지능형 챗봇**을 통해, 단순한 기록 도구가 아닌 실질적인 '안전 조언자' 역할을 수행합니다.
